...
export function AuthPage({ mode, returnTo, invitedEmail }: { mode: "signup" | "login"; returnTo?: string; invitedEmail?: string }) {
  ...
  return <main className={styles.page}>
    ...
    <aside className={styles.story}><div className={styles.photo}>
      {/* <Image src="/images/wedding-celebration.jpg" alt="A wedding celebration filled with flowers and warm light" fill sizes="(max-width: 800px) 100vw, 50vw" priority/> */}
      </div><div className={styles.storyText}><span>MADE FOR YOUR HAPPILY EVER AFTER</span><h2>A little less planning.<br/>A lot more celebrating.</h2><p>One beautiful place for the people, moments, and details that make your wedding yours.</p></div></aside>
  </main>;
}